  ...
  return (
    <section id="about" className="relative w-full overflow-hidden py-16">
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
        {/* Top row: statement and profile image */}
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_310px] lg:gap-8">
          ...
          >
            <div className="relative w-60 sm:w-72 lg:w-80">
              <div className="pointer-events-none absolute inset-0 animate-[profile-pulse_3.5s_ease-in-out_infinite] rounded-full bg-cyan-300/15 blur-3xl" />
          ...
          <div className="flex w-full flex-col gap-4">
            ...
            <div className="max-w-4xl">
              <p className="text-lg leading-8 text-white/80 lg:text-2xl lg:leading-10">
                ...
                , a software engineer and AI/ML enthusiast who builds
                practical, human-centered digital products.
              </p>

              <p className="mt-5 w-full text-base leading-8 text-white/55 lg:max-w-4xl lg:text-xl lg:leading-9">
                I build modern web applications with Next.js, TypeScript, and
                data-driven systems, and I am interested in software
                engineering, AI/ML engineering, and mobile development
                opportunities where technology can create measurable,
                meaningful impact.
              </p>
            </div>
